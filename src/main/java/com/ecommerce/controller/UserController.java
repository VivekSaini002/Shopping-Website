...
public class UserController {
	...
	public String loadCartPage(Principal p, Model m) {
		...
		UserDetl user = getLoggedInUserDetails(p);
	...
	private UserDetl getLoggedInUserDetails(Principal p) {
		String email = p.getName();
		UserDetl userDtls = userService.getUserByEmail(email);
		return userDtls;
	}
	...
	public String myOrder(Model m, Principal p) {
		UserDetl loginUser = getLoggedInUserDetails(p);
	...
	public String changePassword(@RequestParam String newPassword, @RequestParam String currentPassword, Principal p,
			HttpSession session) {
		UserDetl loggedInUserDetails = getLoggedInUserDetails(p);
